...
public class FragmentAdicionarPessoaActivity extends Fragment {

    public static final String id = "FRAGMENT_ADICIONAR_PESSOAS";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.fragment_adicionarpessoasactivity, container, false);
        }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new FragmentAdicionarPessoaActivity()).commitAllowingStateLoss();
            }
        });
    ...
    private void processData() {
        ...
        listaPessoaAdapter = new ListaPessoasAdapter(getActivity(), AdicionarPessoaActivity.dialogHelper, AdicionarPessoaActivity.saspServer, recyclerView, listaPessoas);
