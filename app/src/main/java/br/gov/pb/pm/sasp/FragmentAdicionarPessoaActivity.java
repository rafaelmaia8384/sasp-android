...
public class FragmentAdicionarPessoaActivity extends Fragment {
    ...
    private void processData() {
        ...
        listaPessoaAdapter = new ListaPessoaAdapter(getActivity(), AdicionarPessoaActivity.dialogHelper, AdicionarPessoaActivity.saspServer, recyclerView, listaPessoas);
