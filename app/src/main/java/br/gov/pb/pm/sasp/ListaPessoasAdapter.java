...
public class ListaPessoasAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ListaPessoasAdapter(Context context, DialogHelper dialogHelper, SaspServer saspServer, RecyclerView rv, ArrayList<ListaPessoas> listaPessoas) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof mViewHolder) {
            ...
            ListaPessoas listaPessoa = listaPessoas.get(position);

            String img_busca = listaPessoa.img_perfil_busca;

            if (!img_busca.equals("null")) {

                ImageLoader.getInstance().loadImage(SaspServer.getImageAddress(img_busca, SaspImage.UPLOAD_OBJECT_MODULO_PESSOAS, true), new SimpleImageLoadingListener() {
