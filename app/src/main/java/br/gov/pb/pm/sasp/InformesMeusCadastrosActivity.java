...
public class InformesMeusCadastrosActivity extends SaspActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.informes_activity_meus_cadastros);

        dialogHelper = new DialogHelper(this);
        saspServer = new SaspServer(this);

        Fragment fragment = new InformesFragmentMeusCadastrosActivityMeusCadastros();
